...
Haskell also has the ability to manage strictness issues when defining records. We took advantage of this
capability and defined strictness for some of our data types, thus forcing evaluation whenever
 those data types are used. You can see that we also used unboxed variants of vectors,
...
%
The HF method scales with {\textbf N\textsuperscript{4}}, with N being
